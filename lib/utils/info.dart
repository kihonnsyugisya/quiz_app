...
class Info{
  ...
  static Map<String, Map<String, String>> prList = {
    ...
    '1.1.0': {'pr': 'NORMALとHARDは、たくさんのクイズの中からランダムに10問が出題されます。\n何度でも挑戦してみてください！'},
    '1.1.1': {'pr': 'NORMALとHARDは、たくさんのクイズの中からランダムに10問が出題されます。\n何度でも挑戦してみてください！'},
    '1.2.0': {'pr': 'NORMALとHARDは、たくさんのクイズの中からランダムに10問が出題されます。\n何度でも挑戦してみてください！'},
    '1.2.1': {'pr': 'NORMALとHARDは、たくさんのクイズの中からランダムに10問が出題されます。\n何度でも挑戦してみてください！'},
  };
