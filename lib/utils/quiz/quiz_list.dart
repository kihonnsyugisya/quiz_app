...
class QuizList{
  ...
  static List<QuizEntity> firstNormalList = [
    ...
    QuizEntity(quiz: 'ウェスタリス情報局対東課', answer: ['JUSTICE','WISE','TWICE'], answerOfNum: 1),
    ...
    QuizEntity(quiz: '国家保安局は市民からは何と呼ばれているか', answer: ['特殊警察','秘密警察','極秘警察'], answerOfNum: 2),
  ...
  static List<QuizEntity> secondNormalList = [
    ...
    QuizEntity(quiz: '証明写真機が入り口となっている隠れ家はどれか', answer: ['隠れ家『F』','隠れ家『G』','隠れ家『D』'], answerOfNum: 2),
    QuizEntity(quiz: '入学式でダミアンにからかわれたアーニャがとった最初の行動はどれ', answer: ['逃げ出した','オトナの余裕を見せつけた','泣いた'], answerOfNum: 1),
    QuizEntity(quiz: '入学式の日にダミアンはアーニャをからかい続けた結果どうなったか', answer: ['停学処分になった','トニトを与えられた','顔面を殴られた'], answerOfNum: 2),
    ...
    QuizEntity(quiz: 'アーニャのひっさつのしょっとはどれか', answer: ['えくすかりばー','すたーきゃっちあろー','すーぱーすたーしょっと'], answerOfNum: 1),
  ...
  static List<QuizEntity> firstHardList = [
    ...
    QuizEntity(quiz: 'ビル・ワトキンスのドッジボールにおける奥義はどれか', answer: ['スーパースライダーショット','スーパーライジングショット','デュークホームラン'], answerOfNum: 0),
    QuizEntity(quiz: '水族館で化学兵器のフィルムを飲み込んでいたペンギンの名前は？', answer: ['ぺスカーくん','ペーマスくん','ペャールズくん'], answerOfNum: 2),
    QuizEntity(quiz: 'イーデン校のスペクター寮は第何組か', answer: ['1','2','3'], answerOfNum:0),
